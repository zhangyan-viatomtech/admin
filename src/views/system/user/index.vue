<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      <el-table-column label="userId" align="center" key="userId" prop="userId"/>
      <el-table-column label="邮箱号" align="center" key="email" prop="email" />
      <el-table-column label="注册时间" align="center" key="registerTime" prop="registerTime"/>
      <el-table-column label="注册渠道" align="center" key="channel" prop="channel" />
    </el-table>
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      let userid = 0,pageIndex=1,pageSize=10
      ...
      listUser(data,'change').then(response => {
